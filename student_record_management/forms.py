...
from models import User, Class  # Import models to populate select fields dynamically
...
class StudentRecordForm(FlaskForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Dynamically populate SelectField for students and classes
        self.student_id.choices = [(student.id, student.username) for student in User.query.filter_by(role='Student').all()]
